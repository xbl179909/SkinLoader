...
public class CommonViewHolder {
    ...
    public <T extends View> T getView(int viewId, View.OnClickListener listener){
        View view = mViews.get(viewId);
        if(view == null){
            view = mConvertView.findViewById(viewId);
    ...
    public CommonViewHolder setOnClickListenr(int viewId, View.OnClickListener listener){
        View view = mViews.get(viewId);
